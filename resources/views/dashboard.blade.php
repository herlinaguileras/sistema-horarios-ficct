        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="mb-4 text-lg font-semibold">Reportes</h3>
                    ...
                    <div x-show="activeTab === 'asistencias'">
                        <div class="flex items-center justify-between mb-4"> {{-- Este div alinea el título y los botones --}}
                            ...
                            @if ($semestreActivo)
                            <div> {{-- Contenedor para los botones --}}
                                <a href="{{ route('dashboard.export.asistencia') }}" class="inline-flex items-center px-3 py-1 ml-2 text-xs font-semibold tracking-widest text-white uppercase transition duration-150 ease-in-out bg-green-600 border border-transparent rounded-md hover:bg-green-500 active:bg-green-700 focus:outline-none focus:border-green-700 focus:ring ring-green-300 disabled:opacity-25">Excel</a>
